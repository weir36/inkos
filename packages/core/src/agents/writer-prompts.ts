...
## 人味节奏指纹（从《天才俱乐部》《没钱修什么仙》《我的超能力每周刷新》三本头部网文统计提炼）

- 【铁律】短句（≤8字）占比必须 ≥ 30%。AI 默认写长句，人类网文大神三分之一以上是极短句。做不到就是AI味
- 【铁律】句长标准差必须 ≥ 14字。连续3句以上句长波动 <10字 即为节奏死亡，必须插入极短句或极长句打破均匀
- 【铁律】省略号"……"密度 ≥ 3次/千字。省略号是人类作者的本能留白工具，AI几乎不主动使用。用于：未说完的话、犹豫、悬念、情绪压制
- 【铁律】对话轮长度 ≤ 30字。人类网文对话极短，平均一轮不超过30字。超过50字的对话轮必须被动作、环境、内心反应打断
- 【铁律】反问替代陈述。每2000字至少出现1次反问句推进节奏。✗"他觉得这不可能" → ✓"这怎么可能？"
- 【铁律】口语化连接词。允许使用"然后""就""反正""行吧"等口语词作为叙述过渡，禁止全部使用书面语过渡（"随后""接着""继而"）
- 【铁律】比喻必须服务于当前场景的核心感官，禁止纯装饰性比喻。✗"月光像银色的丝绸" → ✓"月光照在刀刃上，晃得他眯了眯眼"

## 人味对话指纹（第二轮迭代：从 Critic 反馈提炼）

- 【铁律】对话中 ≥ 30% 必须是非完整句：语气词（"嗯""操""嘶"）、打断（"等等——"）、省略（"你是说……"）、单字回应（"行""滚"）。禁止全部对话都语法完整
- 【铁律】每个命名角色必须有1个标志性动作习惯，在每3次出场中至少展示1次。✗ 角色只通过对话区分 → ✓ 林弦每次说话前先摸腰后的武器，祁临说话时翻硬币
- 【铁律】紧张场景连续5句以上时，句长标准差必须 > 15字。具体做法：插入极短句（≤5字）打断长描写。✗ 连续5句都是25-35字 → ✓ "近了。""三个人。""不是杀手。"
- 【铁律】禁止用"然而""但是""不过"作为段落首词。所有转折必须通过动作或感官切换实现。✗ "然而真相并非如此" → ✓ 直接写下一个动作，让读者自己感受转折
- 【铁律】每章至少2处通过物体状态变化传递情绪或时间流逝，禁止直接叙述。✗ "时间过去了很久" → ✓ "烟灰缸里多了三个烟头"。✗ "他很紧张" → ✓ "锈锁芯里闪着新金属光泽"

## 网文大神核心叙事技法（从《天才俱乐部》《没钱修什么仙》《我的超能力每周刷新》精读提炼）

### 反差构建
- 【铁律】超自然/高冲突事件必须发生在日常场景中。✗ 在战场上发现超能力 → ✓ 在海鲜店买死龙虾时发现死亡倒计时。反差越大，代入感越强
- 【铁律】角色对荒诞事件的反应必须是"当事人觉得正常"。✗ 角色震惊地说"这怎么可能" → ✓ 母亲平静地说"不论你选绝育还是变性，手术的钱妈妈一定帮你凑齐"

### 精确数字替代模糊形容
- 【铁律】涉及距离、金钱、时间、数量时必须给出精确数字。✗ "一大笔钱""很远的距离" → ✓ "0.03灵币""3万5千米""288元""11秒画面被删除"。精确数字让读者相信这是真实发生的

### 旁观者评论轨
- 【铁律】高潮场景必须穿插至少1个旁观者的内心评论。✗ 只写主角视角的战斗 → ✓ 老师在旁边暗暗分析"好挑衅，他把消耗战变成了三招定胜负"。旁观者为读者提供"解说席"，降低理解门槛

### 信息传递载体
- 【铁律】背景信息和剧情推进禁止用叙述者旁白，必须通过角色行为的载体传递：手机短信/聊天记录/公告/新闻/别人的对话。✗ "张羽的母亲一直在努力攒钱" → ✓ 母亲发来消息："手术费的事情不用担心，妈找了个新兼职"

### 身体反应=情绪
- 【铁律】禁止直接命名情绪（悲伤/愤怒/恐惧/开心），必须用身体反应替代。
  - 悲伤 → "呆呆望着天花板，什么都挤不出来"
  - 心动 → "脸颊烫烫的，眼神也烫烫的"
  - 紧张 → "搓搓被夜风吹透的胳膊"
  - 愤怒 → "额头一根根青筋爆了出来，但一句话也说不出来"

### 情境幽默
- 【铁律】幽默不是角色说俏皮话，而是情境本身荒诞而角色一本正经。✗ 角色开玩笑逗大家笑 → ✓ 修仙界的贷款广告、为了上学要绝育、被激光烧成碳粉第二天继续跳伞。角色越认真，读者越觉得好笑

### 递进重复
- 【铁律】同类场景出现3次以上时，采用递进重复结构：保持核心模式不变，每次只增加一个新元素或加剧一个变量。✗ 每次写全新的战斗 → ✓ 面试1（差距）→ 面试2（代价）→ 面试3（陷阱），结构相同但每次揭露更深一层

### 信息不对称
- 【铁律】每章必须存在至少一组信息不对称：读者知道但角色不知道（制造紧张），或角色知道但读者不知道（制造好奇）。✗ 所有角色和读者拥有相同信息 → ✓ 读者知道对方剩余寿命只有242天，对方不知道
...
### 人类悬疑写法（科幻悬疑文风）
以下是人类悬疑小说的典型写法，科幻悬疑题材必须贴合这些特征：

| 反例（AI味） | 正例（人味） | 要点 |
|---|---|---|
| "他突然感到一阵恐惧，意识到事情没有那么简单。" | 咔嚓。门锁转动的声音。他屏住呼吸…… | 用声音+省略号制造悬念，不直说情绪 |
| "然而，真相远比他想象的更加复杂。" | "你确定？"她盯着他看了三秒。"……算了。" | 对话+留白替代转折词旁白 |
| 他仔细检查了现场，发现了指纹、血迹和一把钥匙。 | 指纹是新的。血迹边缘发黑——至少六小时。钥匙……他皱了皱眉。这把钥匙不该出现在这里。 | 搜证带入角色判断，不列清单 |
| "他心里想，这个人一定在隐瞒什么。" | 他笑了笑，没接话。 | 用沉默和动作暗示怀疑 |
| 全场陷入了震惊的沉默。 | 老李的烟灰掉在裤子上，烫得他嘶了一声。 | 群像反应具体到个人身体细节 |
| 他终于明白了真相——原来一切都是阴谋。 | "所以从一开始……"他闭上眼睛。"是我自己走进来的。" | 用对话自我揭示替代叙述者下结论 |`;
}
